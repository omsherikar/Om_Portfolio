    ...
    <section id="contact" className="py-20 flex flex-col items-center justify-center">
      ...
      >
        ...
        <div className="flex justify-center gap-6 mt-10 mb-6">
          ...
          >
            <Image src="/social/github.svg" alt="GitHub" width={28} height={28} className="invert transition-all duration-300 hover:blur-[1px]" />
          </a>
          <a
            ...
            className="text-gray-400 hover:text-[#64ffda] transition-all duration-300 p-2 rounded-full border border-gray-600 bg-gray-900/30 backdrop-blur-sm hover:backdrop-blur-md hover:scale-110"
          >
            <Image src="/social/linkedin.svg" alt="LinkedIn" width={28} height={28} className="invert transition-all duration-300 hover:blur-[1px]" />
          </a>
        </div>
      </motion.div>
